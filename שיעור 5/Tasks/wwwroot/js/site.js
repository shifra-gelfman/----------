...
function _displayItems(data) {
    ...
    data.forEach(item => {
        let isDoingCheckbox = document.createElement('input');
        isDoingCheckbox.type = 'checkbox';
        isDoingCheckbox.disabled = true;
        isDoingCheckbox.checked = item.isDone;
        ...
        td1.appendChild(isDoingCheckbox);
